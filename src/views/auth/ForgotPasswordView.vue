...
<template>
  <div class="flex py-8 flex-col">
    <p class="mx-auto max-w-[292px] my-8 text-left text-lg font-bold text-primary xl:text-xl">
    ...
    <form class="space-y-2" @submit.prevent="onSubmit">
      ...
      <div class="pt-4">
        <Button type="submit" button-classes="w-full rounded-[5px] py-3 text-sm font-bold">
          Reset-Link senden
        </Button>
      </div>
