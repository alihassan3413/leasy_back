...
<template>
  <div class="flex flex-col gap-5 h-full">
    ...
    >
      <div class="flex-1">
        <h1 class="text-[18px] font-extrabold text-[#10393b] tracking-[-0.4px]">Kundenverwaltung</h1>
      </div>

      <!-- B2C / B2B toggle -->
      <div class="flex gap-0.5 bg-[#f4f7f6] p-[3px] rounded-[12px]">
        <button
          v-for="opt in [{ label: 'Privatkunden', val: 'B2C' }, { label: 'Firmenkunden', val: 'B2B' }]"
          :key="opt.val"
    ...
    >
      ...
      <div class="flex items-center justify-between mb-5 shrink-0">
        <div>
          <h2 class="text-[20px] font-extrabold text-[#10393b] tracking-[-0.4px]">{{ pageTitle }}</h2>
        ...
        <table class="min-w-full border-collapse">
          <thead class="sticky top-0 z-10">
            <tr class="bg-[#f8faf9]">
              ...
              <th class="text-left text-[11px] font-bold text-[#9bb0af] uppercase tracking-[0.1em] px-5 py-3.5 border-b border-[#eef3f2]">E-Mail</th>
              <th class="text-left text-[11px] font-bold text-[#9bb0af] uppercase tracking-[0.1em] px-5 py-3.5 border-b border-[#eef3f2]">Stadt</th>
              <th class="text-left text-[11px] font-bold text-[#9bb0af] uppercase tracking-[0.1em] px-5 py-3.5 border-b border-[#eef3f2]">Land</th>
              <th class="text-left text-[11px] font-bold text-[#9bb0af] uppercase tracking-[0.1em] px-5 py-3.5 border-b border-[#eef3f2]">Status</th>
              <th class="text-left text-[11px] font-bold text-[#9bb0af] uppercase tracking-[0.1em] px-5 py-3.5 border-b border-[#eef3f2]">Beigetreten</th>
