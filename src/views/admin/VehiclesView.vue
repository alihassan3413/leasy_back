...
<template>
  <div class="flex flex-col gap-5 h-full">
          ...
          <tbody>
            ...
            <template v-else v-for="v in vehicles" :key="v.vehicle_id">
                  ...
                  <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0"
                      ...
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="1.8">
                        <path d="M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v9a2 2 0 01-2 2h-1"></path>
                ...
                <td class="px-3 py-3.5">
                  <div class="flex items-center gap-2">
                    ...
                    <div class="relative">
                      ...
                      <!-- Dropdown menu -->
                      <div v-if="openMenuId === v.vehicle_id"
                        ...
                        <button v-else class="w-full text-left px-4 py-2 text-sm text-[#9bb0af] cursor-not-allowed">
                          <span class="flex items-center gap-2">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                              stroke-width="2">
                              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
              ...
              <Transition name="accordion">
                <AdminVehicleOrderHistory v-if="expandedId === v.vehicle_id" :vehicle="v"
                  :expandedVehicleDetails="expandedVehicleDetails" :documents="documents"
    ...
    <AdminChangeOrderStatusModal :open="statusModalOpen" :order="selectedOrderForStatus"
