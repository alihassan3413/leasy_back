  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    ...
    >
      <div class="relative">
        <button
          @click="close"
          class="absolute -right-1 -top-1 z-10 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 text-white shadow-md transition-colors hover:bg-emerald-600 disabled:opacity-60"
          :disabled="loading"
        >
        ...
        >
          <div class="px-2 pt-2 mb-2">
            <h2 class="text-[24px] font-bold leading-normal text-black">Dokumente abrufen</h2>
          ...
          <div class="mt-8 flex justify-center">
            <button
              class="h-10 px-6 rounded-full text-base font-semibold text-white transition-all duration-200 shadow-lg disabled:opacity-60 disabled:cursor-wait"
