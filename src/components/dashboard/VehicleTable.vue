...
<template>
  ...
  <div class="hidden md:block rounded-[12px] overflow-hidden border border-gray-100 shadow-sm">
    <Table>
      ...
      <TableBody>
        <VehicleRow v-for="vehicle in vehicles" :key="vehicle.id" :vehicle="vehicle"
          :is-expanded="expandedId === vehicle.id" @toggle="handleToggle(vehicle)" />
        ...
        <VehicleRow v-for="vehicle in completedVehicles" :key="vehicle.id" :vehicle="vehicle"
          :is-expanded="expandedId === vehicle.id" @toggle="handleToggle(vehicle)" />
      </TableBody>
    </Table>
  </div>
  ...
  <div class="md:hidden space-y-4">
    ...
    <div v-for="vehicle in vehicles" :key="vehicle.id"
      ...
      <div class="p-4 cursor-pointer" :class="expandedId === vehicle.id ? 'bg-gray-50' : ''"
      ...
      <div class="flex items-center justify-between px-4 py-3 border-t border-gray-100">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <button class="transition-opacity hover:opacity-70 hover:bg-gray-100 p-2 rounded-lg" @click.stop>
    ...
    <!-- Completed vehicles -->
    <div v-for="vehicle in completedVehicles" :key="vehicle.id"
      class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
  ...
  <!-- Order Modal -->
  <OrderCreationModal v-model:open="orderModalOpen" :vehicle="selectedVehicleForOrder" @success="handleOrderSuccess" />
</template>
