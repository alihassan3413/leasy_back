    ...
    >
      <div class="relative">
        ...
        >
          ...
          <!-- Body — two columns -->
          <div class="flex gap-6 px-4 pb-6">
            <!-- Left: file drop zone -->
            <div class="flex flex-1 flex-col gap-2">
              ...
              <!-- Drop area -->
              <div
                class="relative flex h-[130px] w-full cursor-pointer flex-col items-center justify-center rounded-2xl border transition-colors"
                :style="
                  isDragging
            ...
            <div class="flex flex-1 flex-col gap-3">
              <span class="text-sm font-semibold text-black"
                >Dokumenttyp wählen</span
              >

              <div class="relative">
                <div
                  class="flex h-9 cursor-pointer items-center justify-between rounded-full border border-gray-300 px-4 outline-none focus-within:border-emerald-500"
                ...
                >
                  <div
                    ...
                    :key="opt.value"
                    class="flex h-9 cursor-pointer items-center px-4 text-sm hover:bg-gray-50 text-gray-800"
                    @click="
              ...
              <button
                class="h-9 rounded-full bg-emerald-500 px-4 text-sm font-bold text-white transition-opacity hover:opacity-90 shadow-lg"
                :disabled="isLoading"
