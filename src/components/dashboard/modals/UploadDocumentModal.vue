...
async function uploadDocument() {
  ...
  try {
    const newDoc = await vehicleApi.uploadVehicleDocument(
      props.vehicleId,
      formData,
    );
  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogContent class="p-0 gap-0 overflow-visible bg-transparent border-none shadow-none rounded-none"
      ...
      <div class="relative px-3 md:px-0">
        ...
        <div class="bg-white border border-[#C6C6CD] p-3 md:p-4 inverted-corner inverted-corner-top-right"
          ...
          <div class="px-2 md:px-4 pt-2 md:pt-3 mb-2 md:mb-3">
            ...
            <p class="mt-1 mx-0 md:mx-2 pb-2 text-xs md:text-sm font-light leading-normal not-italic text-[#00000080]">
              Laden Sie ganz einfach ein neues Dokument hoch – ziehen Sie die
              Datei dazu auf die Fläche oder wählen Sie sie von Ihrem Rechner
              aus.
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row gap-3 md:gap-5 px-0 md:px-4 pb-4 md:pb-5">
            ...
            <div class="flex flex-1 flex-col gap-2">
              <span class="text-sm font-semibold text-black">Laden Sie ein neues Dokument hoch</span>
              ...
              <div
                ...
                :style="isDragging
                  ...
                  " @click="openFilePicker" @dragover.prevent="isDragging = true" @dragleave="isDragging = false"
                @drop.prevent="onDrop">
                <input ref="fileInput" type="file" accept=".pdf,.jpg,.png" class="hidden" @change="onFileChange" />
            ...
            <div class="flex flex-1 flex-col gap-3">
              ...
              <div class="relative">
                <div
                  ...
                  <span class="text-sm" :class="selectedDocType ? 'text-gray-800' : 'text-gray-400'">
                    {{ selectedDocType || "Dokumenttyp wählen" }}
                  </span>
                  <Icon :icon="docsOpen ? 'mdi:chevron-up' : 'mdi:chevron-down'" class="text-gray-500 text-[24px]" />
                </div>
                ...
                <div v-if="docsOpen"
                  ...
                  <div v-for="opt in docOptions" :key="opt.value"
                    class="flex h-8 cursor-pointer items-center px-4 text-sm hover:bg-gray-50 text-gray-800" @click="
              ...
              <div class="rounded-2xl border border-gray-300 bg-white p-4">
                <p class="mb-2 text-sm font-semibold text-black">
                ...
                <div v-else class="flex flex-col gap-2">
                  <div v-for="doc in documents" :key="doc.id"
                    ...
                    <button type="button" class="text-sm font-semibold text-red-500 hover:text-red-600"
              ...
              <button
                ...
                :disabled="isLoading" @click="uploadDocument">
          ...
          <div class="flex justify-center px-2 md:px-4 pb-3 md:pb-4">
            <button
              ...
              style="background: #ef8450" @click="close">
              Bestätigen
            </button>
          </div>
        </div>
