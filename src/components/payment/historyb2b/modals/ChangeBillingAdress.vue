  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    ...
    >
      <div class="bg-white p-8">
        <h2 class="text-base font-normal text-custom-black mb-2.5">Rechnungsadresse hinzufügen</h2>
        <p class="text-sm font-bold text-custom-black mb-8">
          Falls Sie eine von der bei der Registrierung angegebenen Adresse abweichende
          Rechnungsadresse verwenden möchten, können Sie diese hier festlegen.
        </p>

        <div class="grid grid-cols-2 gap-x-12 gap-y-6 mb-10">
          <!-- Row 1 -->
          <FormTextField name="firmenname" label="Firmenname (lt. HGB/Gewerbeeintrag)" required />
          <FormTextField name="ustIdNr" label="USt-IdNr." required />

          <!-- Row 2 -->
          <FormTextField name="strasse" label="Straße (kein Postfach)" required />
          ...
          <div class="flex flex-col">
            <label class="text-sm font-bold text-custom-black mb-1.5 ml-1"> Land </label>
