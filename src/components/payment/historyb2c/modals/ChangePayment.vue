...
<template>
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogContent
      ...
      style="width: 540px; max-width: 95vw; border-radius: 8px; border: 1px solid #ececec"
      :show-close-button="false"
    >
      <div class="bg-white p-8">
        <h2 class="text-[24px] font-bold text-color-primary mb-8">Zahlungsart auswählen</h2>

        <!-- Step 1: Selection List -->
        <div v-if="currentStep === 1" class="flex flex-col border-t border-[#F3F4F6]">
          <div
          ...
          >
            <div class="flex items-center gap-6">
              ...
              <div class="flex flex-col">
                <span class="text-[17px] font-medium text-custom-black">{{ method.label }}</span>
                <span class="text-[13px] text-custom-black opacity-60">{{ method.subtext }}</span>
              </div>
            </div>

            <div
              class="w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all"
              :class="selectedMethod === method.id ? 'border-custom-orange' : 'border-[#D1D5DB]'"
            >
              <div
        ...
        <div v-else-if="currentStep === 2" class="space-y-6">
          ...
          <div class="flex items-center justify-between py-4 border-b border-[#F3F4F6]">
            <div class="flex items-center gap-6">
              <div class="w-12 flex justify-center">
                <Icon icon="ph:credit-card" class="text-3xl text-custom-black" />
              </div>
              <div class="flex flex-col">
          ...
          <div class="space-y-4 pt-2">
            <div class="flex flex-col gap-1.5">
              ...
              <div class="relative">
                ...
                <div class="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  <Icon icon="ph:credit-card" class="text-xl text-custom-black" />
            ...
            <div class="grid grid-cols-2 gap-6">
              ...
              <div class="flex flex-col gap-1.5">
                <label class="text-[15px] text-custom-black">Sicherheitscode / CVV</label>
                <div class="relative">
                  <input
          ...
          <div class="flex flex-col border-t border-[#F3F4F6] opacity-50 pointer-events-none">
            <div
