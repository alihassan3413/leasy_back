...
<template>
  <div class=" relative ">
    ...
    <!-- Select Box -->
    <div
      class="relative w-57.5 rounded-[5px] border border-green-gray bg-[#ECECEC] cursor-pointer"
      @click="toggleDropdown"
    >

      <!-- Selected Value -->
      <div
        class="flex items-center justify-between px-3 py-px"
      >
    ...
    <div
      v-if="isOpen"
      class="absolute mt-2 w-57.5 rounded-2xl border border-gray-300 bg-gray-100 shadow-lg z-50 overflow-hidden"
    >
