  ...
  <TableRow class="border-0 hover:bg-transparent">
    <TableCell colspan="7" class="p-0">
      ...
      <div class="flex gap-2.5 border-t border-green-gray bg-white p-2" style="min-width: max-content">
        ...
        ───────────────────────────────────────────────── -->
        <div class="flex max-w-[350px]  shrink-0 flex-col overflow-hidden rounded-[5px] border bg-white" style="border-color:#ECECEC">
          <!-- Header -->
          <div class="px-6 py-5">
        ...
        ───────────────────────────────────────────────── -->
        <div class="relative flex w-[240px] shrink-0 flex-col rounded-[5px] border bg-white" style="border-color:#ECECEC">
        ...
        ───────────────────────────────────────────────── -->
        <div class="relative flex w-[190px] shrink-0 flex-col overflow-hidden rounded-[5px] border bg-white" style="border-color:#ECECEC">
